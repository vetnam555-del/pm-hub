(function(){
  'use strict';
  let loading;
  function excel(){if(window.ExcelJS)return Promise.resolve(window.ExcelJS);if(!loading)loading=new Promise((resolve,reject)=>{const s=document.createElement('script');s.src='js/vendor/exceljs.min.js?v=33';s.onload=()=>resolve(window.ExcelJS);s.onerror=()=>{loading=null;reject(Error('엑셀 모듈을 불러오지 못했습니다. 연결을 확인하세요.'));};document.head.append(s);});return loading;}
