...
const SHELL = [
  ...
  './index.html',
  './css/base.css?v=21',
  './css/beginner.css?v=21',
  './css/tools.css?v=21',
  './js/curriculum.js?v=21',
  './js/data/mediamix-data.js?v=21',
  './js/tools/kpi.js?v=21',
  './js/tools/utm.js?v=21',
  './js/tools/budget.js?v=21',
  './js/tools/report.js?v=21',
  './js/tools/diagnose.js?v=21',
  './js/tools/abtest.js?v=21',
  './js/tools/bid.js?v=21',
  './js/tools/pacing.js?v=21',
  './js/tools/mediamix.js?v=21',
  './js/tools/utm-learn.js?v=21',
  './js/app.js?v=21',
  './assets/icon-192.png',
